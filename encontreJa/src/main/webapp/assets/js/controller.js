...
mainApp.controller('contactPersonController', function ($scope, $http, $routeParams, $cookieStore) {
    $scope.formData = "";
    if ($scope.isLogged) {
        ...
        $http.get(url).success(function (response) {
            $scope.user = response;
            $scope.formData.idClient = $cookieStore.get("user");
            $scope.formData.idProfessional = response.id;
            $scope.formData.idService = response.serviceList[0].id;
            ...
            $scope.processForm = function () {
                $http({
                    ...
                    headers: {
                        ...
                        .error(function () {
                            $scope.message = 'Erro ao enviar a mensagem.';
                        })
                        .success(function () {
...
mainApp.controller('addServiceController', function ($scope, $http, $cookieStore, $routeParams) {


    if ($cookieStore.get("user-type") == "professional") {
        $scope.formData = {};
        $scope.formData.userid = $cookieStore.get("user");
        $scope.formData.contactid = $routeParams.id;
        $scope.btnsubmit = "Gravar";
        $scope.message = "";
            ...
            $http({
                ...
                headers: {
                    ...
                    .error(function () {
                        ...
                        $scope.message = 'Erro ao gravar.';
                    })
                    .success(function () {

                        $scope.message = 'Serviço adicionado com sucesso.';
                    });
